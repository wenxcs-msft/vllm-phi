...
__global__ void phi_moe_align_block_size_kernel(scalar_t *__restrict__ topk_ids, 
...
void phi_moe_align_block_size(
    ...
    VLLM_DISPATCH_INTEGRAL_TYPES(
        topk_ids.scalar_type(), "phi_moe_align_block_size_kernel", [&] {
        ...
        auto kernel = vllm::phi_moe_align_block_size_kernel<scalar_t>;
        AT_CUDA_CHECK(
